...
public class Security {
	...
	public static byte[] encryptWithAES(String plainText, String encryptionKey,String IV) throws Exception {
	...
	public static String decryptWithAES(byte[] cipherText, String encryptionKey,String IV) throws Exception{
		Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
		SecretKeySpec key = new SecretKeySpec(encryptionKey.getBytes("UTF-8"), "AES");
